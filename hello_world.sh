...
mvn install:install-file -Dfile=C:\Users\mas00fr\IdeaProjects\misim-orchestration-github\libraries\misim-3.2.jar -DgroupId="cambio.simulator" -DartifactId=misim -Dversion="3.2" -Dpackaging=jar -DgeneratePom=true
