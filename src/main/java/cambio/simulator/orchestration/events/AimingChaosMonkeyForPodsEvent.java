...
public class AimingChaosMonkeyForPodsEvent extends OrchestrationSelfScheduledExperimentAction {
    @Expose
     ...
     */
    public AimingChaosMonkeyForPodsEvent(Model owner, String name, boolean showInTrace, String deploymentName,
                                         int instances, String service, int retries) {
