...
public class KubeJSONCreator {
    ...
    public static String createPod(Pod pod, boolean running) throws IOException, KubeSchedulerException {
        ...
        for (Container container : pod.getContainers()) {
            ...
            String containerTemplateString = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/container.json");
...
//            }
        ...
        String podTemplateString = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/pod.json");
        ...
        if (running) {
            ...
            String pendingStatus = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/status_pending.json");
    ...
    public static String createWatchStreamShellForJSONPod(String k8Object, String type, String kind) throws IOException {
        String watchStreamShell = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/watchStreamShell.json");
...
//            Index needs to be shifted by string length
    ...
    public static String createNode(Node node) throws IOException {
        ...
        String nodeTemplateString = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/node.json");
...
//        TEMPLATE_MACHINE_ID
            ...
            String nodeListTemplateString = getFileContent("src/main/java/cambio/simulator/orchestration/scheduling/kubernetes/nodeList.json");
