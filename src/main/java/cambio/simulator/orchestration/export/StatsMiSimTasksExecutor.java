...
import cambio.simulator.orchestration.events.StatsMiSimEvent;
...
public class StatsMiSimTasksExecutor extends NamedEntity implements ISelfScheduled {
    ...
    public StatsMiSimTasksExecutor(Model model, String name, boolean showInTrace) {
    ...
    public void executeManagementTasks(){
        final StatsMiSimEvent statsEvent = new StatsMiSimEvent(getModel(), "Calculate Stats", traceIsOn());
